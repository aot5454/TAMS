                        ...
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                ...
                                if ($reg['reg_status'] == "deny") { ?>
                                    <div class="m-1">
                                        <a class="btn btn-sm btn-success btn-circle btn-lg" data-tooltip="tooltip" data-placement="right" title="ยอมรับเป็นนิสิตช่วยสอน!" href="#correct" data-href="<?= base_url('admin/change_status_reg/') . $reg['reg_id'] . "/allow/" . $reg['post_id']; ?>" data-toggle="modal" data-target="#confirmStatusNisitAllow">
                                ...
                                if ($reg['reg_status'] == "allow") { ?>
                                    <div class="m-1">
                                        <a class="btn btn-sm btn-success btn-circle" data-tooltip="tooltip" data-placement="right" title="ยอมรับเป็นนิสิตช่วยสอน!" href="#correct" data-href="<?= base_url('admin/change_status_reg/') . $reg['reg_id'] . "/allow/" . $reg['post_id']; ?>" data-toggle="modal" data-target="#confirmStatusNisitAllow">
                                            <i class="fas fa-check"></i>
                                        </a>
                                    </div>
                                    <div class="m-1">
                                        <a class="btn btn-sm btn-danger btn-circle" data-tooltip="tooltip" data-placement="right" title="ไม่ยอมรับเป็นนิสิตช่วยสอน!" href="#notcorrect" data-href="<?= base_url('admin/change_status_reg/') . $reg['reg_id'] . "/deny/" . $reg['post_id']; ?>" data-toggle="modal" data-target="#confirmStatusNisitDeny">
                                            <i class="fas fa-times"></i>
                                        </a>
                                    </div>
                                    <div class="m-1">
                                        <a class="btn btn-sm btn-info btn-circle" data-tooltip="tooltip" data-placement="right" title="ปริ้นใบสมัคร" target="_blank" href="<?= base_url('admin/print/') . $reg['post_id']; ?>">
                                ...
                                if ($reg['reg_status'] == "wait") { ?>
                                    ...
                                    <div class="m-1">
                                        <a class="btn btn-sm btn-danger btn-circle btn-lg" data-tooltip="tooltip" data-placement="right" title="ไม่ยอมรับเป็นนิสิตช่วยสอน!" href="#notcorrect" data-href="<?= base_url('admin/change_status_reg/') . $reg['reg_id'] . "/deny/" . $reg['post_id']; ?>" data-toggle="modal" data-target="#confirmStatusNisitDeny">
                                            <i class="fas fa-times"></i>
                                        </a>
                                    </div>
                                <?php
